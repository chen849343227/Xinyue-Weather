...
/** 
 * DAO for table "WEATHER3_HOUR_DETAIL_INFO".
*/
public class Weather3HourDetailInfoDao extends AbstractDao<Weather3HourDetailInfo, Long> {

    public static final String TABLENAME = "WEATHER3_HOUR_DETAIL_INFO";

    /**
     * Properties of entity Weather3HourDetailInfo.<br/>
    ...
    public Weather3HourDetailInfoDao(DaoConfig config) {
        super(config);
    }
    
    public Weather3HourDetailInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WEATHER3_HOUR_DETAIL_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WEATHER3_HOUR_DETAIL_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Weather3HourDetailInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Weather3HourDetailInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public Weather3HourDetailInfo readEntity(Cursor cursor, int offset) {
        Weather3HourDetailInfo entity = new Weather3HourDetailInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, Weather3HourDetailInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Weather3HourDetailInfo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Weather3HourDetailInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Weather3HourDetailInfo entity) {
